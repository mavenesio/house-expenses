...
function LightOff(props) {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
      data-icon="lightbulb"
      className="prefix__svg-inline--fa prefix__fa-lightbulb prefix__fa-w-11"
      viewBox="0 0 352 512"
      width="1em"
      height="1em"
      {...props}
...
const MemoLightOff = React.memo(LightOff);
export default MemoLightOff;
